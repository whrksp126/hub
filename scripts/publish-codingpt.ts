...
const sections = [
  {
    kind: 'lead',
    heading: '개요 · OVERVIEW',
    body: 'AI에게 일을 맡겨두고 자리를 뜨면, 승인 한 번 하려고 다시 책상 앞으로 와야 합니다. CodingPT는 내 PC를 폰이나 다른 기기에서 그대로 이어 쓰게 합니다. 터미널도 코드도 실행 중인 앱도, 전부 원래 있던 그 PC에서 돌아갑니다.',
    bullets: [
      ...
      '미러링이 아닌 재설계 — 원격 데스크톱처럼 화면을 욱여넣지 않고 터미널·에디터·브라우저·시뮬레이터를 각 기기에 맞는 UI로 다시 만들었습니다',
    ],
  },
  {
    kind: 'default',
    ...
    body:
      '처음 CodingPT는 듀오링고처럼 모바일에서 코딩을 배우는 앱이었습니다. 레슨에 맞춰 만든 코드 실행 시스템 덕분에, 폰에서 코드를 짜도 결과를 그 자리에서 받아볼 수 있는 게 강점이었습니다.\n\n그런데 AI가 빠르게 발전하면서 전제가 흔들렸습니다. 이제는 코딩을 배우지 않아도 원하는 걸 만들 수 있게 됐으니까요. 코딩을 가르치는 일보다, 만들고 싶은 걸 바로 만들게 돕는 일이 더 필요해졌습니다.\n\n그래서 방향을 바꿨습니다. 교육 서비스를 만들며 쌓아둔 코드 실행 모듈을 그대로 살려서, 폰에서도 바이브 코딩을 이어갈 수 있게 만들자는 것이었습니다.\n\n지금 목표는 하나입니다. 누구나, 언제 어디서든, 원하는 걸 쉽고 빠르게 만들 수 있는 도구.'
  },
  {
    kind: 'gallery',
